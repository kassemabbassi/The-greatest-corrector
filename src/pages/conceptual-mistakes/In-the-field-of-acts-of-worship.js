...
export default function SubjectsComponent() {
  ...
  const subjects = [
    {
      title: "الصوم، الحج، والزكاة",
      route: "/conceptual-mistakes/Fasting-Pilgrimage-and-Almsgiving"
    },
    {
      title: "الوضوء والتيمم",
      route: "/conceptual-mistakes/Ablution-and-dry-ablution"
    },
    {
      title: "الصلوات، مبطلاتها، وقضاء الفوائت",
      route: "/conceptual-mistakes/Prayer-its-invalidators-and-missed-prayers"
    }
  ];
